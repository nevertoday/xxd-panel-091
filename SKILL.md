...
```text
/xxd-panel-091 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，091 设计在下）
2. 左右对照（原图在左，091 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-091/<fresh-task>/
...
- `references/xxd-panel-091-prompt.zh-CN.md`
- `references/xxd-panel-091-prompt.en.md`
