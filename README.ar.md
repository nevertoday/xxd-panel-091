<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 091" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 091｜ألبوم السفر بالخط الأزرق

### يرسم الصورة بقلم أزرق واحد كسرد تخطيطي متحفظ
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 091 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.
...
يحفظ **Panel 091** الهوية بمحيط دقيق، ثم ينسج الضوء والحجم والخامة بدرجة زرقاء واحدة من قلم رصاص أو حبر جاف، وتهشير اتجاهي ومتقاطع وخطوط بحث وضغط وحبيبات جافة. تُفصّل المواضع المميزة فقط ويبقى سواها غير مكتمل عمدًا.

### مناسب لـ

- الحفاظ على هوية الموضوع مع حذف معلومات الخلفية غير الضرورية لمعنى المشهد؛
- إظهار حبيبات القلم الأزرق الجافة وآثار الضغط واتجاه الضربات وخطوط البحث؛
- موازنة العلامات المركزة مع بياض الورق الواسع وفق انضباط «التوقف عندما تكفي الملاحظة»؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 091 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** قلم أزرق أحادي · تهشير اتجاهي · تهشير متقاطع · تفاصيل انتقائية · ضبط دفتر الرسم · فراغ سردي
...
```text
تحليل الموضوع والمحيط والوضعية والعلاقة السردية → الاحتفاظ فقط بإشارات الهوية والمعنى → تحديد الشكل بمحيط دقيق → اختيار درجة زرقاء واحدة من الكوبالت أو أزرق الحبر أو ألترا مارين أو النيلي → نسج القيمة والحجم والخامة بواسطة hatching اتجاهي وcross-hatching → تفصيل المواضع المحورية انتقائيًا → تقليل الخطوط حتى تتلاشى في بياض الورق الطبيعي → إضافة قدر قليل من النص التحريري الهادئ
```

## سمات النتيجة النهائية

- استخدم درجة زرقاء واحدة فقط في الرسم من دون لون ثانٍ؛ وابنِ التدرج بسماكة الخط والضغط وعدد التراكبات والكثافة.
- ابنِ المناطق الداكنة بطبقات hatching كثيفة وcross-hatching موضعية، من دون ملء أسود أو تدرجات ناعمة.
- فصّل الشعر والعمارة وانعطافات الأدوات والنباتات وغيرها من المواضع المميزة، وبسّط كل ما عداها.
- اجعل الطباعة صغيرة وهادئة وذات طابع كتابي، بتباعد رحب، وادمجها في المساحة السلبية.
- تجنّب الألوان المائية، وملء الألوان، وكتل الفحم، والتدرجات الضبابية، ومرشحات المحيط، والخطوط السوداء الثقيلة، والمتجهات المصقولة، والرسم التقني، والكرتون، والأنمي، و3D.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-091-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 091. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-091 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-091 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-091 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-091 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-091 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 091 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-091 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-091`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-091-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-091-prompt.zh-CN.md)
...
| **[xxd-panel-091](https://github.com/nevertoday/xxd-panel-091)** | قلم أزرق أحادي · تهشير اتجاهي · تهشير متقاطع · تفاصيل انتقائية · ضبط الرسم · فراغ سردي |
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–091) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
